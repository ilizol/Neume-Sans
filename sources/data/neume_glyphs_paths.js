...
var glyphs_paths_data = {
    ...
    "haple": [
        ['M', 0.6, 0.5],
        ['C', 0.5, 0, 1, 0.5, 0.875, 0],
        ['L', 0.25, 0],
        ['C', 0.3, 0.5, -0.125, 0, 0, 0.5]
    ],
    "diple": [
        // haple 1
        ['M', 0.6, 0.5],
        ...
        // haple 2
        ['M', 0.6 + hapw, 0.5],
        ['C', 0.5 + hapw, 0, 1 + hapw, 0.5, 0.875 + hapw, 0],
        ['L', 0.25 + hapw, 0],
        ['C', 0.3 + hapw, 0.5, -0.125 + hapw, 0, 0 + hapw, 0.5]
    ],
    "triple": [
        // haple 1
        ['M', 0.6, 0.5],
        ...
        // haple 3
        ['M', 0.6 + 2 * hapw, 0.5],
        ['C', 0.5 + 2 * hapw, 0, 1 + 2 * hapw, 0.5, 0.875 + 2 * hapw, 0],
        ['L', 0.25 + 2 * hapw, 0],
        ['C', 0.3 + 2 * hapw, 0.5, -0.125 + 2 * hapw, 0, 0 + 2 * hapw, 0.5]
    ],
    "tetraple": [
        // haple 1
        ['M', 0.6, 0.5],
        ...
        // haple 4
        ['M', 0.6 + 3 * hapw, 0.5],
        ['C', 0.5 + 3 * hapw, 0, 1 + 3 * hapw, 0.5, 0.875 + 3 * hapw, 0],
        ['L', 0.25 + 3 * hapw, 0],
        ['C', 0.3 + 3 * hapw, 0.5, -0.125 + 3 * hapw, 0, 0 + 3 * hapw, 0.5]
    ],
    "vareia": [
        ['M', 0, 2],
        ['C', 5.5, -2, 1.25, -2, 3, -2],
        ['C', 5.5, -1.75, 5.75, -1.95, 5.75, -1.8],
        ['C', 1.5, 2, 2.75, -1.5, 2, -0.5],
        ['C', 0, 2, 1, 2.1, 0.5, 2.1]
    ]
};