...
var glyphs_paths_data = {
    ...
    "haple": [
        ['M', 0.5, 0.5],
        ['C', 0.375, 0, 1, 0.5, 0.875, 0],
        ['C', 0.5, 0.5, -0.125, 0, 0, 0.5]
    ],
    "diple": [
        // haple 1
        ['M', 0.5, 0.5],
        ...
        // haple 2
        ['M', 0.5 + hapw, 0.5],
        ['C', 0.375 + hapw, 0, 1 + hapw, 0.5, 0.875 + hapw, 0],
        ['C', 0.5 + hapw, 0.5, -0.125 + hapw, 0, 0 + hapw, 0.5]
    ],
    "triple": [
        // haple 1
        ['M', 0.5, 0.5],
        ...
        // haple 3
        ['M', 0.5 + 2 * hapw, 0.5],
        ['C', 0.375 + 2 * hapw, 0, 1 + 2 * hapw, 0.5, 0.875 + 2 * hapw, 0],
        ['C', 0.5 + 2 * hapw, 0.5, -0.125 + 2 * hapw, 0, 0 + 2 * hapw, 0.5]
    ],
    "tetraple": [
        // haple 1
        ['M', 0.5, 0.5],
        ...
        // haple 4
        ['M', 0.5 + 3 * hapw, 0.5],
        ['C', 0.375 + 3 * hapw, 0, 1 + 3 * hapw, 0.5, 0.875 + 3 * hapw, 0],
        ['C', 0.5 + 3 * hapw, 0.5, -0.125 + 3 * hapw, 0, 0 + 3 * hapw, 0.5]
    ]
};