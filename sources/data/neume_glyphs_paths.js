...
var glyphs_paths_data = {
    ...
    "psephiston": [
        ['M', 0, 1.3],
        ['C', 1, 1.3, 0.25, 1.5, 0.75, 1.5],
        ['C', 6.25, 1.3, 4.75, -1, 5.25, 1],
        ['C', 7.5, 1.3, 6.5, 1.4, 7.25, 1.4],
        ['C', 0, 1.3, 6.5, -0.5, 3.5, -1]
    ],
    "psephiston-long": [
        ['M', 0, 1.3],
        ['C', 1, 1.3, 0.25, 1.5, 0.75, 1.5],
        ['C', 6.5, 1.3, 4.75, -1, 5.25, 1],
        ['C', 8, 1.3, 6.75, 1.4, 7.75, 1.4],
        ['C', 0, 1.3, 6.75, -0.5, 3.5, -1]
    ],
    "homalon": [
        ['M', 0, 0],
        ['C', 0.5, 0.4, 0, 0.25, 0.25, 0.4],
        ['L', 7, 0.4],
        ['L', 7, 0],
        // diagonal line
        ['M', 7, 1],
        ['C', 8, 1, 7.25, 1.15, 7.75, 1.15],
        ['L', 7, -0.85],
        ['C', 6, -0.85, 6.75, -1, 6.25, -1]
    ],
    "homalon-long": [
        ['M', 0, 0],
        ['C', 0.5, 0.4, 0, 0.25, 0.25, 0.4],
        ...
        // diagonal line
        ['M', 8, 1],
        ['C', 9, 1, 8.25, 1.15, 8.75, 1.15],
        ['L', 8, -0.85],
        ['C', 7, -0.85, 7.75, -1, 7.25, -1]
    ],
    "antikenoma": [
        ['M', 0, 0],
        ['C', 0.5, 0.4, 0, 0.25, 0.25, 0.4],
        ['C', 6, -1, 9, 1, 8.5, -1],
        ['C', 5.5, 0, 4.5, -0.6, 8, -0.4],
        ['C', 0, 0, 3.5, 0.1, 3.5, 0.1]
    ],
    "antikenoma-short": [
        ['M', 0, 0],
        ['C', 0.5, 0.4, 0, 0.25, 0.25, 0.4],
        ['C', 5, -1, 8, 1, 7.5, -1],
        ['C', 4.5, 0, 3.5, -0.6, 7, -0.4],
        ['C', 0, 0, 3.5, 0.1, 3.5, 0.1]
    ],
    "heteron": [
        ['M', 0, 0],
        ['L', 0.5, 0.85],
        ['C', 1.25, 0.85, 0.75, 1, 1, 1],
        ['L', 0.75, 0],
        ['C', 6.75, 0, 3.5, 1, 4.5, -1],
        ['L', 6.5, 0.65],
        ['C', 7.35, 0.75, 6.75, 0.85, 7, 0.85],
        ['C', 7.4, -0.5, 7.4, 0.5, 7.6, -0.25],
        ['C', 0.5, -0.5, 4.5, -1.5, 3.5, 0.5],
        ['C', 0, 0, 0.15, -0.35, 0, -0.15]
    ],
    "heteron-long": [
        ['M', 0, 0],
        ['L', 0.5, 0.85],
        ...
        ['C', 7.75, 0, 4, 1, 5, -1],
        ['L', 7.5, 0.65],
        ['C', 8.35, 0.75, 7.75, 0.85, 8, 0.85],
        ['C', 8.4, -0.5, 8.4, 0.5, 8.6, -0.25],
        ['C', 0.5, -0.5, 5, -1.5, 4, 0.5],
        ['C', 0, 0, 0.15, -0.35, 0, -0.15]
    ],
    "endophonon": [
        ['M', 0, 0],
    ...
    "endophonon-short": [
        ...
        ['C', 5.75, 0, 3, 1, 4, -1],
        ['L', 5.5, 0.65],
        ['C', 6.35, 0.75, 5.75, 0.85, 6, 0.85],
        ['C', 6.4, -0.5, 6.4, 0.5, 6.6, -0.25],
        ['C', 0.5, -0.5, 4, -1.5, 3, 0.5],
        ['C', 0, 0, 0.15, -0.35, 0, -0.15]
    ],
    "ring": [
        ['M', 1, 1.5],
        ...
        ['C', 1, 1.5, 0, 0, 0, 1.5],
        ['M', 1, 1.25],
        ['C', 1, 0.25, 0.35, 1.25, 0.35, 0.25],
        ['C', 1, 1.25, 1.65, 0.25, 1.65, 1.25]
    ],
    "ring-long": [
        ['M', 1.5, 2.25],
        ['C', 1.5, 0, 3, 2.25, 3, 0],
        ['C', 1.5, 2.25, 0, 0, 0, 2.25],
        ['M', 1.5, 2],
        ['C', 1.5, 0.25, 0.35, 2, 0.35, 0.25],
        ['C', 1.5, 2, 2.65, 0.25, 2.65, 2]
    ],
    "gorgon": [
        ['M', 0, 0],
        ['L', 0, 1.25],
